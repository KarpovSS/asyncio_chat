...
class ClientProtocol(asyncio.Protocol):
    ...
    # receiving data from server and showing in message_box
...
class MainWindow(Ui_MainWindow, QMainWindow):
    ...
    def __init__(self):
        ...
        self.send_button.clicked.connect(self.push_button_handler)
        self.message_input.returnPressed.connect(self.push_button_handler)
